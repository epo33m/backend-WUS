...
exports.FirebaseAdminModule = exports.FIREBASE_APP = void 0;
        ...
        providers: [
            {
                ...
                useFactory: (config) => {
                    const serviceAccount = JSON.parse(config.getOrThrow('FIREBASE_SERVICE_ACCOUNT_JSON'));
