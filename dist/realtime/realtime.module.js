...
exports.RealtimeModule = RealtimeModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [sse_service_1.SseService, cashier_gateway_1.CashierGateway, realtime_event_listener_1.RealtimeEventListener],
        exports: [sse_service_1.SseService, cashier_gateway_1.CashierGateway],
    })
], RealtimeModule);
